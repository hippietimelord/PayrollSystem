   ...
   if(isset($_POST['submit']))
	{
	   // Connect to server and select databse.
		...
		$sql="SELECT * FROM $tblname2 WHERE em_id='$EID' and em_pw ='$password'";
...
<body>
	...
	<footer>
		...
		<a style="float: right;font-family: 'Arial';color: black;" href="AdminLogin.php">You can login as Admin&nbsp;&nbsp;</a></p>
	</footer>
</body>
</html>